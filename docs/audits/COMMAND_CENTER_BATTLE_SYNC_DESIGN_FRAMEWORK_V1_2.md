...
| **D-65** | **An engine-outage tick (`haikuError`) is the Why? absence state**, never `Held` with the cron's placeholder words (C1). The label names the persisted fact: `No decision recorded at this check · the evaluation timed out`. | C1, A3 review F12 | **Ruled Sep 2** (A4 seed; A4.0 ruling 4). |
