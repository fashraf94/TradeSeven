      ...
      const response = await fetch('/api/battle-commentary', {
        ...
        body: JSON.stringify({
          ...
          battleState: {
            ...
            creatorBaggerBombs: battleState.creatorBaggerBombs || 0,
            opponentBaggerBombs: battleState.opponentBaggerBombs || 0,
            creatorBusts: battleState.creatorBusts || 0,
            opponentBusts: battleState.opponentBusts || 0,
            totalEventCount: battleState.totalEventCount || 0,
            biggestEvent: battleState.biggestEvent || null,
          },
