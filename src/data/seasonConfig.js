/**
 * Season Mode — Constants & Configuration (Frontend)
 * API mirror exists at api/_utils/seasonConfig.js — keep in sync.
 * Referenced by: season UI, portfolio builder, pit-stop components
 */
