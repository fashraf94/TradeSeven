// /src/components/Dashboard/ClashCard/ClashCard1v1V3.jsx
// V3 BaggerBomb Clash Card with live score calculation via useBaggerBombBattleV3 hook
...
export default function ClashCard1v1V3({
  battle,
  remainingMs,
  onPress,
  isMostUrgent = false,
  ...
  // Use the V3 hook for live calculated scores
  const {
    player,
