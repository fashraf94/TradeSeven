// /src/components/Dashboard/ClashCard/ClashCard1v1V4.jsx
// V4 BaggerBomb Clash Card with live score calculation via useBaggerBombBattleV4 hook
...
export default function ClashCard1v1V4({
  battle,
  remainingMs,
  onPress,
  isMostUrgent = false,
  ...
  // Use the V4 hook for live calculated scores
  const {
    player,
    opponent: hookOpponent,
    isCreator,
    loading,
  } = useBaggerBombBattleV4(battle?.id, currentUserId);
  ...
  const opponentName = isCreator
    ? (battle.opponent?.username || hookOpponent?.username || 'Opponent')
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
          <div style={{ position: 'relative', marginBottom: '8px' }}>
            ...
            <div style={{
              ...
              {(player?.username || 'Y')[0].toUpperCase()}
            </div>
            {/* Crown for winner */}
            {isWinning && (
              <div style={{
