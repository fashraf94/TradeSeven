 ...
 *
 * Features:
 * - Shows DROP → ADD flow visualization
...
const SwapPreview = ({
  ...
  return (
    <div style={{
      ...
      borderTop: `1px solid ${isComplete ? HOLO_COLORS.green : HOLO_COLORS.amber}`,
      padding: '12px 16px',
      ...
      <div style={{
        ...
        <div style={{
          padding: '8px 14px',
          background: isComplete ? 'rgba(0, 255, 136, 0.15)' : HOLO_COLORS.bgCard,
